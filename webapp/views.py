...
from db_interface import add_user, is_login_valid, list_users, get_emails, list_emails, get_user_by_id, get_user_by_login
...
def log_the_user_in(username):
    ...
    if request.method == 'POST':
        session['user_id'] = get_user_by_login(request.form['username']).user_id
